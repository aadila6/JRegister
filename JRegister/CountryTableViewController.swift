...
//        super.viewDidLoad()
//        var allCountries = phoneNumberKit
//        .allCountries()
//        .compactMap({ Country(for: $0, with: self.phoneNumberKit) })
//        .sorted(by: { $0.name.caseInsensitiveCompare($1.name) == .orderedAscending })
//        print(allCountries)
...
////        return CountryCodePickerViewController(phoneNumberKit: phoneNumberKit).numberOfSections(in: tableView)
//    }
//
//    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
//        // #warning Incomplete implementation, return the number of rows
////        return CountryCodePickerViewController(phoneNumberKit: phoneNumberKit).tableView(tableView, numberOfRowsInSection: section)
//    }
//
//
//    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
////        var cell = tableView.dequeueReusableCell(withIdentifier: "reuseIdentifier", for: indexPath)
////        cell = CountryCodePickerViewController(phoneNumberKit: phoneNumberKit).tableView(tableView, cellForRowAt: indexPath)
////
////        return cell
//    }
//
